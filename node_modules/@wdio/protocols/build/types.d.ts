...
export type SupportedMethods = ('session.status' | 'session.new' | 'session.subscribe' | 'session.unsubscribe' | 'browsingContext.captureScreenshot' | 'browsingContext.close' | 'browsingContext.create' | 'browsingContext.getTree' | 'browsingContext.handleUserPrompt' | 'browsingContext.navigate' | 'browsingContext.reload' | 'browsingContext.contextCreated' | 'browsingContext.contextDestroyed' | 'browsingContext.navigationStarted' | 'browsingContext.fragmentNavigated' | 'browsingContext.domContentLoaded' | 'browsingContext.load' | 'browsingContext.downloadWillBegin' | 'browsingContext.navigationAborted' | 'browsingContext.navigationFailed' | 'browsingContext.userPromptClosed' | 'browsingContext.userPromptOpened' | 'script.disown' | 'script.callFunction' | 'script.evaluate' | 'script.getRealms' | 'script.realmCreated' | 'script.realmDestoyed' | 'log.entryAdded');
