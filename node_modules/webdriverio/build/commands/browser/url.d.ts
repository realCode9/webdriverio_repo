 ...
 *
 */
export declare function url(this: WebdriverIO.Browser, path: string): Promise<string | import("webdriver/build/bidi/localTypes.js").BrowsingContextNavigateResult>;
